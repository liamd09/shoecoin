...
uint256 hashGenesisBlock("0xc3f245168555b26af66905e63dc382b40ed054ed0cf3a25930389405f01d2ed3");
...
const string strMessageMagic = "shoecoin Signed Message:\n";
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // shoecoin: 1 days
static const int64 nTargetSpacing = 60; // shoecoin: 1 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal shoecoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "shoecoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Who doesn't like shoes?";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1388879974; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1345972;

        if (fTestNet)
        {
            block.nTime    = 1388884864;
            block.nNonce   = 1485583;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x7befe0fe191ab4ab6ea02e50b8b4630189be15c1b98d1963d612696daeb91c10"));
